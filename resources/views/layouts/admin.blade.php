                ...
                <div class="py-4 text-gray-500 dark:text-gray-400">
                    ...
                    <ul>
                        <li class="relative px-6 py-3">
                            ...
                            <button
                                class="inline-flex focus:outline-none items-center justify-between w-full text-sm font-semibold {{ \Route::current()->getName() == 'admin.products' ? 'text-gray-800' : '' }} transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                                @click="togglePagesMenu"
                                aria-haspopup="true"
                            >
                                <span class="inline-flex items-center {{ \Route::current()->getName() == 'admin.products' || \Route::current()->getName() == 'admin.categories' || \Route::current()->getName() == 'admin.brands' ? 'dark:text-gray-100' : '' }}">
                            ...
                            <template x-if="isPagesMenuOpen">
                                <ul
                                    ...
                                    aria-label="submenu"
                                >
                                    <li class="px-2 py-1 transition-colors duration-150 {{ \Route::current()->getName() == 'admin.products' ? 'text-gray-800 dark:text-gray-100' : '' }} hover:text-gray-800 dark:hover:text-gray-200">
                                        <a class="w-full" href="{{ route('admin.products') }}">Products</a>
                                    </li>
                                    <li class="px-2 py-1 transition-colors duration-150 {{ \Route::current()->getName() == 'admin.brands' ? 'text-gray-800 dark:text-gray-100' : '' }} hover:text-gray-800 dark:hover:text-gray-200">
                                        <a class="w-full" href="{{ route('admin.brands') }}">
                                            Brands
                                        </a>
                                    </li>
                                    <li class="px-2 py-1 transition-colors duration-150 {{ \Route::current()->getName() == 'admin.categories' ? 'text-gray-800 dark:text-gray-100' : '' }} hover:text-gray-800 dark:hover:text-gray-200">
                        ...
                        <li class="relative px-6 py-3">
                            <a href="{{ route('admin.manageuser')}}" class="inline-flex items-center {{ \Route::current()->getName() == 'admin.manageuser' ? 'dark:text-gray-100' : '' }} w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" >
                                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="px-6 my-6">
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="{{ route('logout') }}"
                                    ...
                                    ">
                                <button
                                class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Logout
                            </a>
                        </form>
                ...
                <div class="py-4 text-gray-500 dark:text-gray-400">
                    ...
                    <ul class="mt-6">
                        <li class="relative px-6 py-3">
                            ...
                            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="{{ route('admin.overview') }}">
                                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                    <path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                                </svg>
                                <span class="ml-4">Dashboard</span>
                    ...
                    <ul>
                        <li class="relative px-6 py-3">
                            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="{{ route('admin.orders') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                  </svg>
                                <span class="ml-4">Orders</span>
                    ...
                    <div class="px-6 my-6">
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="{{ route('logout') }}"
                                    ...
                                    ">
                                <button
                                class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Logout
                            </a>
                        </form>
                            <span class="ml-2" aria-hidden="true">-</span>
                        </button>
